...
if __name__ == '__main__':
    ...
    def plot_curve(data, label, color='blue'):
        plt.plot(range(1, NUM_EPOCHS + 1), data, label=label, color=color)
        plt.legend()
    ...
    plt.subplot(1, 2, 1)
    plot_curve(results['ssim'], 'SSIM', 'red')
    ...
    plt.subplot(1, 2, 2)
    plot_curve(results['psnr'], 'PSNR', 'blue')
